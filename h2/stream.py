...
class H2Stream(object):
    ...
    def _build_headers_frames(self,
        ...
        if headers:
            ...
            # Slice into blocks of max_outbound_frame_size. Be careful with
            # this: it only works right because we never send padded frames or
            # priority information on the frames. Revisit this if we do.
            header_blocks = [
